...
app.controller("ctrl", function ($scope, $http, $timeout, $window) {
    ...
    var tours = [
        ...
        },
        {
            ...
            horarios: ['Everyday'],
            modalidades: [
                { id: 0, precio: 55, nino: 0, descripcion: 'Higuey City Tour' }
            ]
        },
        {
            id: 38,
        ...
        {
            id: 40,
            titulo: "Outback Experience Punta Cana",
            partyBoat: false,
            mostrar: true,
            ...
            descripcion_completa: `
                <h2 class="col-xs-12 text-center">Description</h2>
                <p class="col-xs-12">
                    <strong>Available in Punta Cana, Bayahibe and La Romana!</strong>
                    <br><br>Relax and let us show you the natural beauty of the real Dominican Republic!
                    <br><br>Your journey heads out deep into the breathtaking tropical countryside where our wonderful guides will amaze you with cool information about our history, culture, plants and animals. This is a day for everyone, packed with fun and adventure from start to finish.
                    <br><br>The lush tropical scenery and natural beauty of the areas visited will make it a day to remember. You’ll have a chance to visit a typical Dominican country home and meet the family, as well as the local schools and kids. Take the opportunity to explore the coffee and cacao plantations, and even try some of the local exotic fruits!
                    <br><br>You’ll arrive to the Iguana Ranch just in time for a lunch so good you’ll be asking for seconds! To top it off, you’ll get a side dish of unforgettable views thanks to the hilltop location. Do a little exploring and meet our iguanas, turtles, crocodiles, alligators, donkeys, goats, aquatic birds and much more.
                    <br><br>An exclusive and educational stop for Outback Adventures clients; the Coconut stop! Find out why coconut is being called the miracle nut. See how coconuts are processed for their meat, shell, husk fibers, milk and oil; each of which have hundreds of uses.
                    <br><br>To end a fabulous day with a bang, you’ll get to go boogie boarding on a beautiful Caribbean beach. This is an inclusive day, so the drinks are free flowing and lunch is so good you’ll be asking for seconds!
                </p>

                <h2 class="col-xs-6 text-center">Good to Know</h2>
                <h2 class="col-xs-6 text-center">All passengers need to bring the following</h2>
                ...
                <ul class="col-xs-6">
                    <li>Sandals or old tennis shoes (they may get wet!).</li>
                    <li>Sunscreen.</li>
                    <li>Camera.</li>
                    <li>Some $$$ for shopping.</li>
                    <li>Bathing suit / towel.</li>
                </ul>

                <h2 class="col-xs-12 text-center">Outback Experience Punta Cana Itinerary</h2>

                <ul class="col-xs-12">
                    <strong>8 am-9:30 pm Hotel pick up. 4:30 pm thru 5:30 pm return to the hotels</strong>
                    <li>Pass by a local School and explanation on local educational system.</li>
                    <li>Arrive to our IGUANA Ranch and experience the following:</li>
                    <ul>
                        <li>Learn and observe our Fauna Native and introduce animals (Iguanas, Crocodiles, etc) and farm animals.</li>
                        <li>Hand rolled cigar demonstration.</li>
                        <li>Local Craft.</li>
                        <li>Sugar cane history & products.</li>
                    </ul>
                    <li>Typical Dominican lunch is served (family style buffet)</li>
                    <li>Shopping at a local rum shack with local products like rum, cigars, and coffee. All at local prices and with live demonstration of the mastership of the cigar roller, artist painter or rock carver.</li>
                    <li>Visit an authentic Dominican home, see how local people live. Also walk through coffee and cocoa plantations learning everything about how organic chocolate and coffee are made.</li>
                    <li>Visit the Coconut stop and learned everything about the coconut and the products made from it, including health uses and benefits.</li>
                    <strong>Arrive to the beautiful Beach. Safety briefing and orientation of how to boogie board.</strong>
                    <li>Free flowing drinks all day long – This includes Coke, Diet Coke, Sprite, purified water, beer and rum. All are served from a chilled icebox throughout the day.</li>
                    <li>Professionally trained Guides who will explain the history, culture, plants and animals and the way that Dominicans have lived for over 500 years.</li>
                    <li>Language spoken: English, Spanish (Monday thru Saturday), French (Tuesday, Thursdays and Saturdays) and German (Wednesdays and Fridays).</li>
                </ul>
                ...
                <p class="col-xs-12">
                    ...
                    <br><br>Adults 90 US $ per person.
                    <br>Children 45 US $ per person (from 3 to 12 years old).
                    <br>Infants up to 2 years old free of charges.
                </p>
            `,
            horarios: ['Everyday'],
            modalidades: [
                { id: 0, precio: 90, nino: 45, descripcion: 'Outback Experience Punta Cana' }
            ]
        },
        {
            id: 41,
            ...
            descripcion_completa: `
                <h2 class="col-xs-12 text-center">Description</h2>
                <p class="col-xs-12">
                    Ever felt like treating yourself and your family to a once in a lifetime experience? Here is your chance to buckle up in air-conditioned SUV vehicles to enjoy personalized VIP treatment in our Outback Explorer adventure. Our guides are proud to show you hidden secrets that our island holds. We’ll drive you out into the countryside with style in comfortable jeeps. The Adventure driver guide also becomes your exclusive butler, having a fully stocked bar always accompanying you.
                    <br><br>To star our journey the guide will explain the history of the country as we drive thru the villages learning amazing and interesting facts on local life. We continue on and stop at a school in El Caño village. It is one of the various schools that Outback Adventures sponsors so you get to see how you give back to the local communities just by being on the tour and will explain you on our educational system! The children will welcome you with the biggest smiles ever!
                    <br><br>In this unique tour, you’ll be invited into a country home owned by a family that has been in the area for generations! Once you’ve had a glimpse of Dominican country living, you’ll get to walk through the house and get to see their coffee and cacao plantations and organic production and even get a chance to buy the organic goods that are produced on-site.
                    <br><br>Enjoy a delicious á la carte Dominican lunch served at a mountain ranch you will never forget.
                    <br><br>At Rancho Iguana walking by animal pens with rabbits, peacocks, flamingos and learning of their wellbeing. Here as well you will see one of the best reproduction sites for native iguanas in the Dominican Republic, recognized by the University of San Diego CA and the Santo Domingo Zoo. Also, we will show you the native ¨Lago Enriquillo¨ or Enriquillo Lake crocodiles. Nothing like seeing these creatures from close.
                    <br><br>Coming down the mountain we will be hosted by a beautiful family. They will show you anything and everything that can be made from a coconut; from the shell to the nut, every bit is an asset and you’ll get to test the purest coconut oil available anywhere. We will not leave before rehydrating with a fresh coconut water sipped directly from the fruit or a wonderful coco-loco!
                    <br><br>Saying good-by to them we are heading back to the beach. To end a fabulous day with a bang, you’ll get to go boogie boarding or just have some relaxing time while getting tanned on a beautiful Caribbean beach.
                    <br><br><strong>Our tour operates, Monday to Saturday.</strong> We accommodate groups and special events any day; however, spaces are limited, so please place your request in advance.
                </p>

                <h2 class="col-xs-6 text-center">Good to Know</h2>
                <h2 class="col-xs-6 text-center">You need to bring</h2>
                ...
                <ul class="col-xs-6">
                    <li>Comfortable footwear (flip flops are fine)</li>
                    <li>Some money for the shopping in the countryside</li>
                    <li>Towel</li>
                    <li>Camera</li>
                    <li>Sunscreen</li>
                    <li>Swimsuit</li>
                ...
                <p class="col-xs-12">
                    ...
                    <br><br>Adults 150 US $ per person.
                    <br>Children 99 US $ per person (from 3 to 12 years old).
                    <br>Infant 0-2 are free unless a baby seat is required.
                </p>
            `,
            horarios: ['Everyday'],
            modalidades: [
                { id: 0, precio: 150, nino: 99, descripcion: 'Outback Explorer' }
            ]
        },
        {
            id: 42,
            titulo: "Outback Experience-Half Day",
            partyBoat: false,
            mostrar: true,
            ...
            descripcion_completa: `
                <h2 class="col-xs-12 text-center">Description</h2>
                <p class="col-xs-12">
                    Give us a chance to leave you speechless in a fun filled morning. We’ll take you out to the country side deep into the REAL Dominican Republic. Let us take your breath away with the spectacular scenery as you learn about Dominican culture, customs, history and plants.
                    <br><br>You’ll have a chance to visit a typical Dominican country home and meet the family, stop at a local school and learn about our educational system. You’ll feel like you’re taking a trip back in time when you see the simplicity of country life in the Caribbean. Take the opportunity to explore the coffee and cacao plantations and learn about the growth and process of these marvelous products!
                    <br><br>From the local artisans learn about our tobacco production and hand rolling technique.
                    <br><br>To end a fabulous day with a bang, you’ll get to go boogie boarding on a beautiful Caribbean beach. The drinks are free flowing and snacks are waiting for you at the beach.
                ...
                <ul class="col-xs-6">
                    <li>Comfortable footwear (flip flops are fine)</li>
                    <li>Some money for countryside shopping</li>
                    <li>Towel</li>
                    <li>Camera</li>
                    <li>Sunscreen</li>
                    <li>Swimsuit</li>
                ...
                <h2 class="col-xs-6 text-center">Outback Experience-Half Day Itinerary</h2>
                <h2 class="col-xs-6 text-center">Important</h2>

                <ul class="col-xs-6">
                    <li>Hotel pick up.</li>
                    <li><strong>10:15 am-10:30 am</strong> stop at a local School and explanation of our educational system.</li>
                    <li><strong>11:00 am-11:15 am</strong> Visit an authentic Dominican home, see how local people live.</li>
                    <li><strong>11:30 am-11:45am</strong> Walk through the coffee and cocoa plantations and learn everything about how organic chocolate and coffee are grown and processed.</li>
                    <li>Chance to buy organic goods produced onsite</li>
                    <li><strong>12:30 pm</strong> Arrive to a beautiful Beach. Snakcs. Safety briefing and orientation of how to boogie board.</li>
                    <li><strong>1:00 pm thru 1:30pm</strong> departure to return to the hotels</li>
                    <li>Free flowing drinks all day long – This includes Coke, Diet Coke, Sprite, purified water, beer and rum. All are served from a chilled icebox throughout the day.</li>
                    <li>Light snack is included at the beach.</li>
                    <li>Professionally trained Guides who will explain the history, culture, plants and animals and the way that Dominicans have lived for over 100 years.</li>
                    <li>Language spoken: English, French, Spanish and German.</li>
                </ul>

                <ul class="col-xs-6">
                    <li>All reservations are managed by our main operations office in Punta Cana.</li>
                    <li>Pregnant ladies are not permitted to take this tour.</li>
                    <li>Any person with back complications should seek professional advice before taking this tour.</li>
                </ul>
                ...
                <p class="col-xs-12">
                    ...
                    <br><br>Adults 75 US $ per person.
                    <br>Children 37.50 US $ per person (from 3 to 12 years old).
                    <br>Infant 0-3 are free unless a baby seat is required.
                    <br><br><strong>Note:</strong> The tour last approx 4-5 hours.
                    <br><strong>Tour operates Tuesdays, Thursdays, Saturdays.</strong>
                </p>
            `,
            horarios: ['Everyday'],
            modalidades: [
                { id: 0, precio: 75, nino: 37.50, descripcion: 'Half Day' }
            ]
        },
        {
            id: 43,
